...
//     #[pallet::storage]
//     pub type Todos<T: Config> =
//         StorageMap<_, Blake2_128Concat, T::AccountId, BoundedVec<u8, ConstU32<100>>, ValueQuery>;

//     #[pallet::event]
//     #[pallet::generate_deposit(pub(super) fn deposit_event)]
//     pub enum Event<T: Config> {
//         TodoAdded(T::AccountId, BoundedVec<u8, ConstU32<100>>),
//     }
...
//         #[pallet::call_index(0)]
//         #[pallet::weight({
//             let todo_len = todo.len() as u64;
//             Weight::from_parts(10_000 + todo_len * 100, 0)
//         })]
//         pub fn add_todo(
//             origin: OriginFor<T>,
//             todo: BoundedVec<u8, ConstU32<100>>,
//         ) -> DispatchResult {
//             let who = ensure_signed(origin)?;
//             Todos::<T>::insert(&who, todo.clone());
//             Self::deposit_event(Event::TodoAdded(who, todo));
//             Ok(())
//         }
//     }
// }
